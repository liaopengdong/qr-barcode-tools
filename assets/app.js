const TOOLS = {"url-qr-payload": {"title": "URL QR Payload Builder", "desc": "Create a clean URL payload for a QR code generator.", "category": "QR Payloads", "kind": "qrPayload", "fields": [{"id": "url", "label": "URL", "type": "text", "value": "https://example.com"}], "manual": false}, "wifi-qr-payload": {"title": "WiFi QR Payload Builder", "desc": "Build a standard WiFi QR payload string.", "category": "QR Payloads", "kind": "wifiPayload", "fields": [{"id": "ssid", "label": "Network name", "type": "text", "value": "Guest WiFi"}, {"id": "password", "label": "Password", "type": "text", "value": "guest-password"}, {"id": "security", "label": "Security", "type": "select", "value": "", "options": [["WPA", "WPA/WPA2"], ["WEP", "WEP"], ["nopass", "No password"]]}], "manual": false}, "vcard-qr-payload": {"title": "vCard QR Payload Builder", "desc": "Build a vCard contact payload for QR codes.", "category": "Contact", "kind": "vcardPayload", "fields": [{"id": "name", "label": "Full name", "type": "text", "value": "Jane Smith"}, {"id": "phone", "label": "Phone", "type": "text", "value": "+1 555 0100"}, {"id": "email", "label": "Email", "type": "text", "value": "jane@example.com"}, {"id": "org", "label": "Organization", "type": "text", "value": "Example Co"}], "manual": false}, "mailto-link-builder": {"title": "Mailto Link Builder", "desc": "Create a mailto link with subject and body.", "category": "Contact", "kind": "mailto", "fields": [{"id": "email", "label": "Email", "type": "text", "value": "hello@example.com"}, {"id": "subject", "label": "Subject", "type": "text", "value": "Hello"}, {"id": "body", "label": "Body", "type": "textarea", "value": "I would like to learn more."}], "manual": false}, "sms-link-builder": {"title": "SMS Link Builder", "desc": "Create SMS link payloads for mobile campaigns.", "category": "Contact", "kind": "sms", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+15550100"}, {"id": "message", "label": "Message", "type": "text", "value": "Hello"}], "manual": false}, "tel-link-builder": {"title": "Telephone Link Builder", "desc": "Create clickable tel links for websites and QR payloads.", "category": "Contact", "kind": "tel", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+15550100"}], "manual": false}, "geo-link-builder": {"title": "Geo Location Link Builder", "desc": "Build a geo URI from latitude and longitude.", "category": "QR Payloads", "kind": "geo", "fields": [{"id": "lat", "label": "Latitude", "type": "number", "value": 40.7128}, {"id": "lng", "label": "Longitude", "type": "number", "value": -74.006}, {"id": "label", "label": "Label", "type": "text", "value": "New York"}], "manual": false}, "calendar-ics-builder": {"title": "Calendar ICS Builder", "desc": "Create a simple calendar event ICS text.", "category": "Events", "kind": "ics", "fields": [{"id": "title", "label": "Event title", "type": "text", "value": "Team meeting"}, {"id": "start", "label": "Start", "type": "datetime-local", "value": "2026-05-14T09:00"}, {"id": "end", "label": "End", "type": "datetime-local", "value": "2026-05-14T10:00"}, {"id": "location", "label": "Location", "type": "text", "value": "Online"}], "manual": false}, "upc-check-digit": {"title": "UPC Check Digit Calculator", "desc": "Calculate or validate UPC-A check digits.", "category": "Barcode Checks", "kind": "upc", "fields": [{"id": "digits", "label": "First 11 or full 12 digits", "type": "text", "value": "03600029145"}], "manual": false}, "ean-check-digit": {"title": "EAN-13 Check Digit Calculator", "desc": "Calculate or validate EAN-13 check digits.", "category": "Barcode Checks", "kind": "ean", "fields": [{"id": "digits", "label": "First 12 or full 13 digits", "type": "text", "value": "400638133393"}], "manual": false}, "isbn-13-checker": {"title": "ISBN-13 Checker", "desc": "Validate ISBN-13 check digit.", "category": "Barcode Checks", "kind": "isbn13", "fields": [{"id": "isbn", "label": "ISBN-13", "type": "text", "value": "9780306406157"}], "manual": false}, "qr-data-length-checker": {"title": "QR Data Length Checker", "desc": "Estimate QR payload length and scannability risk.", "category": "QR Payloads", "kind": "qrLength", "fields": [{"id": "text", "label": "Payload text", "type": "textarea", "value": "https://example.com"}], "manual": false}, "qr-url-length-checker": {"title": "QR URL Length Checker", "desc": "Estimate QR scannability risk for long campaign URLs and landing page links.", "category": "QR Payloads", "kind": "qrLength", "fields": [{"id": "text", "label": "URL or payload", "type": "textarea", "value": "https://example.com/product?utm_source=newsletter&utm_campaign=spring"}], "manual": false}, "event-ics-generator": {"title": "Event ICS Generator", "desc": "Build a simple calendar event ICS file body for meetings, webinars, and reminders.", "category": "Events", "kind": "ics", "fields": [{"id": "title", "label": "Event title", "type": "text", "value": "Product demo"}, {"id": "start", "label": "Start", "type": "datetime-local", "value": "2026-05-15T10:00"}, {"id": "end", "label": "End", "type": "datetime-local", "value": "2026-05-15T11:00"}, {"id": "location", "label": "Location", "type": "text", "value": "Online"}], "manual": false}, "sms-campaign-link-builder": {"title": "SMS Campaign Link Builder", "desc": "Create SMS link payloads for mobile campaigns and QR code landing flows.", "category": "Contact", "kind": "sms", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+15550100"}, {"id": "message", "label": "Message", "type": "text", "value": "Reply YES to confirm"}], "manual": false}, "phone-qr-link-builder": {"title": "Phone QR Link Builder", "desc": "Create a tel link that can be used in QR codes, contact pages, and mobile buttons.", "category": "Contact", "kind": "tel", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+1 555 0100"}], "manual": false}, "location-qr-link-builder": {"title": "Location QR Link Builder", "desc": "Build geo URI payloads for map QR codes and location sharing.", "category": "QR Payloads", "kind": "geo", "fields": [{"id": "lat", "label": "Latitude", "type": "number", "value": 37.7749}, {"id": "lng", "label": "Longitude", "type": "number", "value": -122.4194}, {"id": "label", "label": "Label", "type": "text", "value": "San Francisco"}], "manual": false}, "business-card-vcard-builder": {"title": "Business Card vCard Builder", "desc": "Build a vCard payload for QR business cards and contact sharing.", "category": "Contact", "kind": "vcardPayload", "fields": [{"id": "name", "label": "Full name", "type": "text", "value": "Alex Morgan"}, {"id": "phone", "label": "Phone", "type": "text", "value": "+1 555 0199"}, {"id": "email", "label": "Email", "type": "text", "value": "alex@example.com"}, {"id": "org", "label": "Organization", "type": "text", "value": "Example Studio"}], "manual": false}, "wifi-guest-qr-builder": {"title": "Guest WiFi QR Builder", "desc": "Build a WiFi QR payload for guest networks, offices, shops, and events.", "category": "QR Payloads", "kind": "wifiPayload", "fields": [{"id": "ssid", "label": "Network name", "type": "text", "value": "Guest Network"}, {"id": "password", "label": "Password", "type": "text", "value": "welcome-2026"}, {"id": "security", "label": "Security", "type": "select", "value": "WPA", "options": [["WPA", "WPA/WPA2"], ["WEP", "WEP"], ["nopass", "No password"]]}], "manual": false}, "isbn-check-digit-calculator": {"title": "ISBN Check Digit Calculator", "desc": "Validate ISBN-13 numbers and review the calculated check digit.", "category": "Barcode Checks", "kind": "isbn13", "fields": [{"id": "isbn", "label": "ISBN-13", "type": "text", "value": "9780131103627"}], "manual": false}, "advanced-url-qr-payload": {"title": "Advanced URL QR Payload Builder", "desc": "Create a clean URL payload for a QR code generator. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "QR Payloads", "kind": "qrPayload", "fields": [{"id": "url", "label": "URL", "type": "text", "value": "https://example.com"}], "manual": false}, "quick-wifi-qr-payload": {"title": "Quick WiFi QR Payload Builder", "desc": "Build a standard WiFi QR payload string. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "QR Payloads", "kind": "wifiPayload", "fields": [{"id": "ssid", "label": "Network name", "type": "text", "value": "Guest WiFi"}, {"id": "password", "label": "Password", "type": "text", "value": "guest-password"}, {"id": "security", "label": "Security", "type": "select", "value": "", "options": [["WPA", "WPA/WPA2"], ["WEP", "WEP"], ["nopass", "No password"]]}], "manual": false}, "planning-vcard-qr-payload": {"title": "Planning vCard QR Payload Builder", "desc": "Build a vCard contact payload for QR codes. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "Contact", "kind": "vcardPayload", "fields": [{"id": "name", "label": "Full name", "type": "text", "value": "Jane Smith"}, {"id": "phone", "label": "Phone", "type": "text", "value": "+1 555 0100"}, {"id": "email", "label": "Email", "type": "text", "value": "jane@example.com"}, {"id": "org", "label": "Organization", "type": "text", "value": "Example Co"}], "manual": false}, "mobile-mailto-link-builder": {"title": "Mobile Mailto Link Builder", "desc": "Create a mailto link with subject and body. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Contact", "kind": "mailto", "fields": [{"id": "email", "label": "Email", "type": "text", "value": "hello@example.com"}, {"id": "subject", "label": "Subject", "type": "text", "value": "Hello"}, {"id": "body", "label": "Body", "type": "textarea", "value": "I would like to learn more."}], "manual": false}, "small-business-sms-link-builder": {"title": "Small Business SMS Link Builder", "desc": "Create SMS link payloads for mobile campaigns. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "Contact", "kind": "sms", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+15550100"}, {"id": "message", "label": "Message", "type": "text", "value": "Hello"}], "manual": false}, "creator-tel-link-builder": {"title": "Creator Telephone Link Builder", "desc": "Create clickable tel links for websites and QR payloads. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "Contact", "kind": "tel", "fields": [{"id": "phone", "label": "Phone", "type": "text", "value": "+15550100"}], "manual": false}, "student-geo-link-builder": {"title": "Student Geo Location Link Builder", "desc": "Build a geo URI from latitude and longitude. Use this focused variant for student workflows and long-tail search scenarios.", "category": "QR Payloads", "kind": "geo", "fields": [{"id": "lat", "label": "Latitude", "type": "number", "value": 40.7128}, {"id": "lng", "label": "Longitude", "type": "number", "value": -74.006}, {"id": "label", "label": "Label", "type": "text", "value": "New York"}], "manual": false}, "team-calendar-ics-builder": {"title": "Team Calendar ICS Builder", "desc": "Create a simple calendar event ICS text. Use this focused variant for team workflows and long-tail search scenarios.", "category": "Events", "kind": "ics", "fields": [{"id": "title", "label": "Event title", "type": "text", "value": "Team meeting"}, {"id": "start", "label": "Start", "type": "datetime-local", "value": "2026-05-14T09:00"}, {"id": "end", "label": "End", "type": "datetime-local", "value": "2026-05-14T10:00"}, {"id": "location", "label": "Location", "type": "text", "value": "Online"}], "manual": false}, "audit-upc-check-digit": {"title": "Audit UPC Check Digit Calculator", "desc": "Calculate or validate UPC-A check digits. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Barcode Checks", "kind": "upc", "fields": [{"id": "digits", "label": "First 11 or full 12 digits", "type": "text", "value": "03600029145"}], "manual": false}, "checklist-ean-check-digit": {"title": "Checklist EAN-13 Check Digit Calculator", "desc": "Calculate or validate EAN-13 check digits. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "Barcode Checks", "kind": "ean", "fields": [{"id": "digits", "label": "First 12 or full 13 digits", "type": "text", "value": "400638133393"}], "manual": false}, "campaign-isbn-13-checker": {"title": "Campaign ISBN-13 Checker", "desc": "Validate ISBN-13 check digit. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Barcode Checks", "kind": "isbn13", "fields": [{"id": "isbn", "label": "ISBN-13", "type": "text", "value": "9780306406157"}], "manual": false}, "batch-qr-data-length-checker": {"title": "Batch QR Data Length Checker", "desc": "Estimate QR payload length and scannability risk. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "QR Payloads", "kind": "qrLength", "fields": [{"id": "text", "label": "Payload text", "type": "textarea", "value": "https://example.com"}], "manual": false}};
